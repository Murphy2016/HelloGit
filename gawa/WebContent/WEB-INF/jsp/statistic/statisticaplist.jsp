...
<!--     <a  class="easyui-linkbutton" onclick="maptable()">图表</a> -->
	...
	<table id="dg" title="统计信息" class="easyui-datagrid" style="width:100%;"
		...
		<thead>
			<tr>
				<th field="date1"        width="100">日期</th>
				<th field="service_online"             width="50">服务在线数</th>
				<th field="service_offline"             width="50">服务离线数</th>
				<th field="data_online"          width="50">数据在线数</th>
				<th field="date_offline"          width="50">数据离线数</th>
				<th field="working"          width="50">设备工作数</th>
				<th field="maintain"          width="50">设备维护数</th>
				<th field="exception"          width="50">设备异常数</th>
	...
	<script>
        		...
        		if( (v && v.length>0) && (v1 && v1.length>0) ){
        			...
        			$.post(myurl,function(result){
        				if (result.success){
        					...
        					highchart(result.date,result.count,result.count1,result.count2);
        ...
        function highchart(date,count,count1,count2) {
