var china = [
             ...
             ['重庆市','万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','江津区','合川区','南川区','永川区','北部新区'],
             //华北地区
             ...
             function BindCity(City,ProvinceData){
                var opt0 = "省份";
                var ProvinceCount=china.length;
                var ddlProvince = document.getElementById("ddlProvince");
                ddlProvince.innerHTML = "";
                ...
                for(var i=0; i<cityCount; i++){
                    ...
                    //alert(china[selectProvinceIndex][i])
