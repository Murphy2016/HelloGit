...
<div>
          <h1 class="page-header">设备监控-时间段</h1>

          <div  style="margin-left:37px;margin-top:5px;">
				<div style="display:inline;">开始日期：</div>
				<%-- <input id="start"  style="display:inline;" placeholder="yyyy-MM-dd" value="${start }"></input> --%>
				<div class="input-group date" style="display:inline;">
				<input id="start" type="text" value="${start }">
				</div>
				
				<div style="display:inline;">结束日期：</div>
				<%-- <input id="end" style="display:inline;" placeholder="yyyy-MM-dd" value="${end }"></input> --%>
				<div class="input-group date" style="display:inline;">
		  ...
		  <div id="hicontainerperiod" hide="true" style="width:100%; height:400px;"></div>
    ...
    <script type="text/javascript">
		...
		
		{
			...
			var start = $("#start").val();
	    	var end = $("#end").val();
			var myurl ='getmapdata?sn='+'hicontainerperiod&type=period&start='+start+'&end='+end;
		...
		function search(){
	    	...
	    	window.location.href='period?start='+start+'&end='+end;
	    }
