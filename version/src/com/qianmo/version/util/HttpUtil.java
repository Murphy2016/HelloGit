...
//					System.out.println(paraMap.get(key));
	...
	private static void test1(){
		...
		String md5sign = sign;//MD5Util.MD5(sign);
	...
	public static void test12(){
		...
		//{searchday:"2017-01-18"}
		String cnt = "{\"searchday\":\"2017-01-18\",\"dotvalue\":100}";
		String res = doPost(url,cnt);
		System.out.println(res);
	}
	...
	public static void test17(){
		...
		//{searchday:"2017-01-18"}
		String cnt = "{\"start_day\":\"2017-01-01\",\"end_day\":\"2017-01-08\"}";
		String res = doPost(url,cnt);
		System.out.println(res);
	}
	public static void test18(){
		...
		//{searchday:"2017-01-18"}
		String cnt = "{\"start_day\":\"2017-01-10\",\"end_day\":\"2017-01-20\"}";
		String res = doPost(url,cnt);
		System.out.println(res);
	}
